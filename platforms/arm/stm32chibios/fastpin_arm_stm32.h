...
#define _RD32(T) struct __gen_struct_ ## T { static __attribute__((always_inline)) inline volatile stm32_gpio_t* r() { return T; } };
...
// Define STM32 port/pins to Arduino like numbers
// For example _DEFPIN_ARM(1, 3, C); means that STM32 C3 pin is defined as Arduino pin 1
#define MAX_PIN 1
_DEFPIN_ARM(0, 7, B);
_DEFPIN_ARM(1, 3, C);
